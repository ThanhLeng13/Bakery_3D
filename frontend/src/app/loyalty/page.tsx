...
function ProgressBar({
  ...
  const progress = ((current % pointsPerVoucher) / pointsPerVoucher) * 100;
  ...
  return (
    <div>
      ...
      >
        <span>{current % pointsPerVoucher} / {pointsPerVoucher} điểm</span>
        <span>đến voucher tiếp theo</span>
      </div>
      <div
        style={{
      ...
      >
        <div
          style={{
            height: "100%",
            width: `${progress}%`,
            background: "linear-gradient(90deg, #3d6b35 0%, #8cbd6e 100%)",
            borderRadius: "9999px",
            transition: "width 0.8s ease-out",
            boxShadow: "0 0 8px rgba(140,189,110,0.5)",
          }}
        />
      </div>
    </div>
