...
export const metadata: Metadata = {
  title: "Trang chủ",
  description:
    "Bơ Nơ – Thiết kế bánh kem theo ý muốn với công cụ trực quan 3D và AI tư vấn thông minh bằng tiếng Việt tại TP.HCM.",
};
    ...
    <main className="min-h-screen bg-cream">
      ...
      <footer className="bg-mocha text-white/80 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 text-center font-body text-xs sm:text-sm">
          <p className="mb-1 sm:mb-2">🎂 Bơ Nơ — Tiệm Bánh Kem Thủ Công</p>
