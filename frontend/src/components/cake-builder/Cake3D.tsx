...
function Macaron({ p }: { p: [number, number, number] }) {
  ...
  return (
    <group position={p}>
      ...
      {/* Phần nhân kem giữa (độ dày 0.022) */}
